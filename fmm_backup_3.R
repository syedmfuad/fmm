...
#gamma_opt <- optim(g[(gvs*3+1):(4*gvs)],FnFour,j=types,d=d,z=Z,y=Y,control=list(fnscale=-1,maxit=100000),hessian=TRUE)
#g4 <- gamma_opt$par
#gse4 <- sqrt(-diag(solve(gamma_opt$hessian[1:gvs,1:gvs])))
...
#lbk_black = sf::st_crop(lbk_black, xmin=-101.873, xmax=-102.300, ymin=31.899, ymax=33.60)

#lbk_med_income = sf::st_crop(lbk_med_income, xmin=-101.873, xmax=-102.300, ymin=31.899, ymax=33.60)
